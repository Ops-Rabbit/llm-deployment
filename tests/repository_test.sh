...
assert_contains 'glm-5.2-w4a16-a100' scripts/run-model.sh
assert_contains 'VLLM_USE_FLASHINFER_SAMPLER=0' scripts/run-model.sh
assert_contains 'VLLM_USE_DEEP_GEMM=0' scripts/run-model.sh
assert_contains '--dtype bfloat16' scripts/run-model.sh
assert_contains '--reasoning-parser glm45' scripts/run-model.sh
assert_contains '--tool-call-parser glm47' scripts/run-model.sh
assert_contains '--enable-auto-tool-choice' scripts/run-model.sh
...
assert_contains 'A100_MODEL_ID="lowbitcoffee/GLM-5.2-W4A16"' lib/common.sh
assert_contains 'A100_MODEL_REVISION="55c92ae85b7ec564c94634964b6f5efe5c09a844"' lib/common.sh
assert_contains 'A100_CONTEXT_LENGTH=32768' lib/common.sh
