...
assert_contains 'glm-5.2-w4a16' profiles/glm-5.2-w4a16.conf
assert_contains 'VLLM_USE_FLASHINFER_SAMPLER=0' profiles/glm-5.2-w4a16.conf
assert_contains 'VLLM_USE_DEEP_GEMM=0' profiles/glm-5.2-w4a16.conf
assert_contains '--dtype bfloat16' profiles/glm-5.2-w4a16.conf
assert_contains '--reasoning-parser glm45' profiles/glm-5.2-w4a16.conf
assert_contains '--tool-call-parser glm47' profiles/glm-5.2-w4a16.conf
assert_contains '--enable-auto-tool-choice' profiles/glm-5.2-w4a16.conf
